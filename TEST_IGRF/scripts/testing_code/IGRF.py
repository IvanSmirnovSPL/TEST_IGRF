...
IGRF_COEFS_TABLE = np.genfromtxt('./testing_code/igrf13coeffs.txt', dtype=str)[1:]

X_CIP_COEFS_TABLES = [np.genfromtxt('./testing_code/tab5.2a.txt', dtype=float, skip_header=36, skip_footer=298),
                      np.genfromtxt('./testing_code/tab5.2a.txt', dtype=float, skip_header=1345, skip_footer=44),
                      np.genfromtxt('./testing_code/tab5.2a.txt', dtype=float, skip_header=1601, skip_footer=7),
                      np.genfromtxt('./testing_code/tab5.2a.txt', dtype=float, skip_header=1640, skip_footer=2),
                      np.genfromtxt('./testing_code/tab5.2a.txt', dtype=float, skip_header=1647)]

Y_CIP_COEFS_TABLES = [np.genfromtxt('./testing_code/tab5.2b.txt', dtype=float, skip_header=35, skip_footer=317),
                      np.genfromtxt('./testing_code/tab5.2b.txt', dtype=float, skip_header=1000, skip_footer=39),
                      np.genfromtxt('./testing_code/tab5.2b.txt', dtype=float, skip_header=1280, skip_footer=8),
                      np.genfromtxt('./testing_code/tab5.2b.txt', dtype=float, skip_header=1313, skip_footer=2),
                      np.genfromtxt('./testing_code/tab5.2b.txt', dtype=float, skip_header=1321)]

sXY_CIO_COEFS_TABLES = [np.genfromtxt('./testing_code/tab5.2c.txt', dtype=float, skip_header=40, skip_footer=37),
                        np.genfromtxt('./testing_code/tab5.2c.txt', dtype=float, skip_header=76, skip_footer=33),
                        np.genfromtxt('./testing_code/tab5.2c.txt', dtype=float, skip_header=82, skip_footer=7),
